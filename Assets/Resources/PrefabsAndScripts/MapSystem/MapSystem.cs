...
public class MapSystem 
{
    ...
    private void startTransition(string map)
    {
        ...
        switch (transition)
        {
			...
			case transitions.fade:
				transitionObject = UnityEngine.Object.Instantiate(Resources.Load(global.dirPrefabs+"Effects/sceneFadeOut")) as GameObject;
				transitionStage = 0;
			break;
        }
    }
	...
	public void fadeComplete()
	{
		...
		{
			sceneLoad(nextMap);
			instantiateOnSceneLoaded(global.dirPrefabs+"Effects/sceneFadeIn");
			transitionStage = 1;
		}
	}
